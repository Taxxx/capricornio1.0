...
public class FrmUsrFirma extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form FrmUsrFirma
     */
    public FrmUsrFirma(FrmMenu menu, int gestion, int cod_almacen) {
        this.menu=menu;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Relacion Usuario - Firma");

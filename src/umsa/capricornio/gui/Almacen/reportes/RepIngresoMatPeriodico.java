 ...
 */
package umsa.capricornio.gui.Almacen.reportes;
 ...
 * @author julian
 */
public class RepIngresoMatPeriodico {     
      
    URL urlMaestro,urlImage;
    public void Reporte (List aux)
    {          
        RepIngresoMatPeriodico t1 = new RepIngresoMatPeriodico(); 
        Map parameters = new HashMap();
        
        urlMaestro = t1.getClass().getResource("/umsa/capricornio/gui/reports/IngresoMaterialPeriodico.jasper");        

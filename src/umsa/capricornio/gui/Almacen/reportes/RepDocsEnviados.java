 ...
 * @author julian
 */
public class RepDocsEnviados {     
      
    URL urlMaestro,urlImage;
    public void Reporte (List aux)
    {          
        RepDocsEnviados t1 = new RepDocsEnviados(); 
        Map parameters = new HashMap();
        
        urlMaestro = t1.getClass().getResource("/umsa/capricornio/gui/reports/DocumentosEnviados.jasper");        

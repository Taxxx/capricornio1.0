...
public class FrmTransacciones extends javax.swing.JInternalFrame {
    ...
    void AbreItems(){
        ...
        if ("ALM1".equals(TblTransaccionBandeja.getValueAt(fila, 1).toString()) || "JUR".equals(TblTransaccionBandeja.getValueAt(fila, 1).toString())){           
            ...
            DiagOrdenesDetalle ordenes= new DiagOrdenesDetalle(this,menu,cod_almacen, Integer.parseInt(TblTransaccionBandeja.getValueAt(fila, 2).toString()),cod_rol,  TblTransaccionBandeja.getValueAt(fila, 5).toString(), gestion, Integer.parseInt(TblTransaccionBandeja.getValueAt(fila, 3).toString()),TblTransaccionBandeja.getValueAt(fila, 1).toString(),TblTransaccionBandeja.getValueAt(fila, 6).toString(),TblTransaccionBandeja.getValueAt(fila, 7).toString(),TblTransaccionBandeja.getValueAt(fila, 8).toString(),TblTransaccionBandeja.getValueAt(fila, 4).toString(),TblTransaccionBandeja.getValueAt(fila, 10).toString(),TblTransaccionBandeja.getValueAt(fila, 11).toString(),TblTransaccionBandeja.getValueAt(fila, 12).toString(),this.cod_usuario);
            ordenes.AbreDialogo(); 
            //LlenaBandeja();
            //LlenaEstados();

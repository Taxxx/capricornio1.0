 ...
 * @author UMSA-JES
 */
public class ProponentesDialog1 extends javax.swing.JDialog {
     ...
     */
    public ProponentesDialog1(java.awt.Frame parent, boolean modal, int cod_transaccion, int cod_trans_nro) {
        //this.menu=parent;
        super(parent, modal);
        initComponents();
